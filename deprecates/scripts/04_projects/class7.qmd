...
knitr::include_graphics("project-day-1-files/thisisfine.gif")
```
...
knitr::include_graphics("project-day-1-files/charlie-day.gif")
```
...
knitr::include_graphics("project-day-1-files/thumbs_up.gif")
```
:::
