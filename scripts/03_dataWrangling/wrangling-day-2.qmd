...
It looks like our data, `cell_props`, is formatted with the samples as rows and the different cell types measured as columns. 
...
```{r pivot_gif,echo=FALSE, fig.align = 'center', out.width = "80%", fig.cap = "Source: Garrick Aden-Buie’s (@grrrck) Tidy Animated Verbs modified by Mara Averick (@dataandme)"}
