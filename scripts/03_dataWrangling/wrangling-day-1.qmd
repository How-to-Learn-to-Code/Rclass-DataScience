...
The pipe operator (`%>%`) from the `magrittr` package, which is incorporated into `dplyr`, allows us to pass the result of one function directly into the next. Think of it as saying, "and then.."
