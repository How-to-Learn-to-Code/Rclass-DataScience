...
subtitle: "H2L2C, Project Management Day 1"
author: "Brian Gural"
format: html
output:
  html_document:
...
Don't think it's worth it? Here are some moments that UNC researchers wished they had stored their data on:
...
Here's how the messy naming system would look in `git`:
...
1.  Introduce our Github and Longleaf accounts to each other with something called a `SSH` keyy
