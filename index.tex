...
{\centering \includegraphics{https://docs.posit.co/ide/user/ide/guide/ui/images/rstudio-panes-labeled.jpeg}
...
{\centering \includegraphics{scripts/02_dataViz/class4_files/figure-pdf/numvsnum2-1.pdf}
...
\hypertarget{base-r-7}{%
\subsubsection{base r}\label{base-r-7}}
...
{\centering \includegraphics{scripts/02_dataViz/class4_files/figure-pdf/histogram-1.pdf}
...
{\centering \includegraphics[width=0.7\textwidth,height=\textheight]{scripts/04_projects/project-day-1-files/thisisfine.gif}
...
{\centering \includegraphics[width=0.7\textwidth,height=\textheight]{scripts/04_projects/project-day-1-files/charlie-day.gif}
...
\hypertarget{data-preview-2}{%
\subsubsection{Data preview}\label{data-preview-2}}
